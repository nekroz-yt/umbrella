...
public class BleuBlock extends Umbrellav2ModElements.ModElement {
	@ObjectHolder("umbrellav2:bleu")
	public static final Block block = null;
	public BleuBlock(Umbrellav2ModElements instance) {
		super(instance, 11);
	}

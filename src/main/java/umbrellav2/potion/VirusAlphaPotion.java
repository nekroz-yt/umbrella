...
public class VirusAlphaPotion extends Umbrellav2ModElements.ModElement {
	@ObjectHolder("umbrellav2:virus_alpha")
	public static final Effect potion = null;
	@ObjectHolder("umbrellav2:virus_alpha")
	public static final Potion potionType = null;
	public VirusAlphaPotion(Umbrellav2ModElements instance) {
		super(instance, 7);

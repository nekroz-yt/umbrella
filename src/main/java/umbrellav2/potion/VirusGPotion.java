...
public class VirusGPotion extends Umbrellav2ModElements.ModElement {
	@ObjectHolder("umbrellav2:virus_g")
	public static final Effect potion = null;
	@ObjectHolder("umbrellav2:virus_g")
	public static final Potion potionType = null;
	public VirusGPotion(Umbrellav2ModElements instance) {
		super(instance, 9);
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			super(EffectType.NEUTRAL, -10092340);
			setRegistryName("virus_g");
